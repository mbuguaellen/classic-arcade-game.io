...
var Engine = (function(global) {
    ...
    function startScreen() {
        ...
        ctx.fillText(" MY ARCADE GAME", 70, 90);
    ...
    function GameOver() {
		...
		ctx.font = "bold 20pt Arial";
        ctx.fillStyle = "#b3003b";
        ctx.fillText("MY ARCADE GAME", 70, 80);

        ctx.font = "bold 50pt Arial";
        ctx.fillStyle = "#862d2d";
        ctx.fillText("GAME OVER", 50, 250);
		ctx.font = "bold 22pt Arial";
        ctx.fillStyle = "#b3003b";
        ctx.fillText("YOUR SCORE: " + score, 130, 320);
		ctx.font = "normal 12pt Arial";
        ctx.fillText("OOPS! F5 TO PLAY AGAIN!" , 87, 420);
		
		
		ctx.beginPath();
        ctx.strokeStyle = "#862d2d";
        ctx.moveTo(0, 550);
        ctx.lineTo(canvas.width, 550);
        ctx.stroke();
    ...
    function GameWin() {
		...
		ctx.font = "bold 22pt Arial";
        ctx.fillStyle = "blue";
        ctx.fillText(" YIPPE YOU WON THE GAME",100,300);
        ctx.fillText("YOUR SCORE: " + score, 130, 380);
		ctx.font = "normal 12pt Arial";
        ctx.fillText("OOPS! F5 TO PLAY AGAIN!" , 87, 450);
